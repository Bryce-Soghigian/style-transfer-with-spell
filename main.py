...
style = load_image("./images/dancing.jpeg")
print(style.shape)
...
for i, layer in enumerate(vgg.features):
    if isinstance(layer, torch.nn.MaxPool2d):
        vgg.features[i] = torch.nn.AvgPool2d(
...
# content image so we can make this a reuseable func to allow a user to pass in any image
content = load_image('./images/picaso.jpg')
...
plt.axis("off")
plt.savefig("./images/bryce_starry.png")